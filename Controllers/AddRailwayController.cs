...
namespace TrainReseravtion.Controllers;
    ...
    public class AddRailwayController : Controller
    {
        ...
        public AddRailwayController(ApplicationDbContext context)
        {
            _context = context;
        ...
        [HttpGet]
        public IEnumerable<Railways> GetRailways()
        {
            List<Railways> railwaysList = new List<Railways>();
            var railways = _context.Railways.ToList();
            
            foreach (var f in railways)
            {
                railwaysList.Add(new Railways()
                {
                    RailwaysNumber = f.RailwaysNumber,
                    RailwaysName = f.RailwaysName,
                    Source = f.Source,
        ...
        public IActionResult AddRailway()
        {
            return View();
        }
        ...
        [HttpPost]
        [Authorize(Roles = "Admin")]
        public IActionResult AddRailway(Railways flt)
        {
            //var request = HttpContext.Request;

            var railways = new Railways
            {
                RailwaysNumber = flt.RailwaysNumber,
                RailwaysName = flt.RailwaysName,
                Source = flt.Source,
            ...
            _context.Railways.Add(railways);
            ...
            var seating = new RailwaysSeating
            {
                RailwaysNumber = flt.RailwaysNumber,
            ...
            _context.RailwaysSeatings.Add(seating);
            _context.SaveChanges();
